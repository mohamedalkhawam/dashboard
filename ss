          ...
          <div className="py-16 bg-white border rounded shadow-md hover:shadow-lg px-14 ">
            ...
            <div className="flex my-5 flex-wrap justify-between">
              <div className=" flex my-1 flex-grow">
                <select
                  ...
                  className="w-full sm:w-6/12 p-4 mr-1 font-normal text-gray-600 border rounded-md shadow outline-none focus:outline-none"
                >
                ...
                <input
                  ...
                  className="w-full sm:w-6/12 p-4 ml-1 md:mr-2 font-normal text-gray-600 border rounded-md shadow outline-none focus:outline-none text-center sm:text-left"
                />
              </div>
              <div
                onClick={(e) =>
            ...
            <div className="flex flex-wrap w-full">
              {formData.services.map((service) => (
                <div className="relative px-3 py-3 pr-6  text-xs text-white bg-blue-500 rounded cursor-pointer m-2 hover:bg-blue-600">
                  <span className="mx-2">
                    name:
